...
fun PantallaAdmin(navController: NavHostController) {
    ...
    LazyColumn(
        ...
        // -----------------------------
        // Bumper 1: Resumen stock y ventas
        // -----------------------------
        item {
            Card(
        ...
        item {
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Text("Productos", fontSize = 20.sp, color = Color(0xFF3B006A))
                    Spacer(modifier = Modifier.height(8.dp))
        ...
        item {
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Text("Usuarios", fontSize = 20.sp, color = Color(0xFF3B006A))
                    Spacer(modifier = Modifier.height(8.dp))
                    usersList(usuarios)
                }
            }
